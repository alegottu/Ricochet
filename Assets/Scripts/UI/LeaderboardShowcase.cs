...
public class LeaderboardShowcase : MonoBehaviour
{
	...
	public void Load()
	{
		_playerScoreText.text = "Your score: " + GameStateManager.GetScore().ToString();
		...
		Leaderboards.Ricochet.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
	...
	public void Submit()
	{
		Leaderboards.Ricochet.UploadNewEntry(_playerUsernameInput.text, GameStateManager.GetScore(), Callback, ErrorCallback);
	}
	
	public void DeleteEntry()
	{
		Leaderboards.Ricochet.DeleteEntry(Callback, ErrorCallback);
	}
	...
	{
		Leaderboards.Ricochet.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
	}
